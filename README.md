...
Nagios Core 4.4.10 running on Ubuntu 20.04 LTS with NagiosGraph, NRPE, NCPA, NSCA, and NRDP.
...
| Build Arg | Default Value | Description |
| ------- | ------- | ------ |
| NAGIOS_VER | 4.4.10 | The Nagios Core release version |
| NAGIOS_PLUGINS_VER | 2.4.3 | The Nagios Plugins release version |
