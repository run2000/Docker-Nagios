...
Nagios Core 4.5.11 running on Ubuntu 24.04 LTS with NagiosGraph, NRPE, NCPA, NSCA, and NRDP.
...
| ------- | ------- | ------ |
| UBUNTU_VERSION | 24.04 | Ubuntu Noble LTS release image |
