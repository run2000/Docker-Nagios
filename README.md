...
Nagios Core 4.4.11 running on Ubuntu 20.04 LTS with NagiosGraph, NRPE, NCPA, NSCA, and NRDP.
...
| Build Arg | Default Value | Description |
| ------- | ------- | ------ |
| NAGIOS_VER | 4.4.11 | The Nagios Core release version |
| NAGIOS_PLUGINS_VER | 2.4.4 | The Nagios Plugins release version |
